...
Abstract:    
    Реализация некоторых WinApi интерфейсов
...
public:
    ...
    static void SetWndProc(decltype(WNDCLASSEXW::lpfnWndProc) newWndProc)
    {
        WndProc = newWndProc;
    }
    ...
    /// </summary>
    /// <returns>WndProc</returns>
    decltype(WNDCLASSEXW::lpfnWndProc) GetWndProc(void)
    {
        return WndProc;
    }
